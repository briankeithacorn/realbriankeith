...
const APP_NAME = "Brian Keith";
const DESCRIPTION =
  "I stand for manufacturing freedom for American small business owners. Fractional COO. Builder of Acorn. Systems that give founders their time — and their families — back.";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Brian Keith" },
    ],
    links: [
